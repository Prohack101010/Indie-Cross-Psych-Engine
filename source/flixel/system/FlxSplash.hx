...
class FlxSplash extends FlxState
{
	...
	{
        FlxG.sound.load(FlxAssets.getSound("flixel/sounds/flixel"), 0.0000001).play(); //preload sound?
        ...
        var bitmapData:BitmapData = Assets.getBitmapData("assets/images/Loading_screen.png");
        var bitmap:Bitmap = new Bitmap(bitmapData);
        icBG = new Sprite();
        icBG.addChild(bitmap);
        icBG.alpha = 0.0001;
		FlxG.stage.addChild(icBG);
		...
		var dtf = new TextFormat("assets/fonts/Bronx.otf", 16, 0xffffff);
		dtf.align = TextFormatAlign.CENTER;
		_text.defaultTextFormat = dtf;
		_text.text = "Indie Cross\n(HaxeFlixel)";
