...
class Note extends FlxSprite
{
	...
	public var hitsoundDirectory:String = null;
		...
		if (noteData > -1 && noteType != value)
		{
			switch (value)
			{
				...
				case 'Blue Bone Notes':
					if (PlayState.SONG.song.toLowerCase() == 'sansational' && !PlayState.instance.attacked)
					{
						reloadNote('noteSkins/yepThisIsNothing');
						noteSplashData.texture = 'noteSplashes/noteSplashes-yepThisIsNothing';
						hitHealth = 0;
					}
					else
					{
						reloadNote('noteSkins/BBONE_assets');
						noteSplashData.texture = 'noteSplashes/noteSplashes-BBone';
						hitHealth = -2;
					}
					// gameplay data
					lowPriority = true;
				...
				case 'Orange Bone Notes':
					...
					{
						reloadNote('noteSkins/OBONE_assets');
						noteSplashData.texture = 'noteSplashes/noteSplashes-OBone';
						// gameplay data
						missHealth = 0;
					}
				case 'Parry':
					reloadNote('noteSkins/NOTE_parry');
					noteSplashData.texture = 'noteSplashes/noteSplashes-parry';
					hitsound = 'parry';
					hitsoundDirectory = 'cup';
